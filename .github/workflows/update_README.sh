...
ipython -c 'import lenscat; from astropy.table.pprint import conf; conf.max_width=-1; conf.max_lines=10; lenscat.catalog' > output_catalog.out
...
# Run python to get the output
ipython -c 'import lenscat, numpy; from astropy.table.pprint import conf; conf.max_width=-1; conf.max_lines=10; lenscat.catalog.search(grading="confident", lens_type="cluster", zlens_range=(1,numpy.inf)).show_ref()' > output_search_confident_cluster.out
...
# Run python to get the output
ipython -c 'import lenscat; from astropy.table.pprint import conf; conf.max_width=-1; conf.max_lines=10; lenscat.catalog.search(lens_type="galaxy").crossmatch("GW170814_skymap.fits.gz")' > output_search_GW170814.out
...
# Run python to get the output
ipython -c 'import lenscat; from astropy.table.pprint import conf; conf.max_width=-1; conf.max_lines=10; lenscat.catalog.crossmatch("glg_healpix_all_bn240229588.fit")' > output_search_GRB.out
